...
const Experience = () => {
  return (
    <section className="bg-2 flex flex-col  gap-7 xl:flex-row">
      <div className="bg-black-200 dark:bg-white-800 max-w-full rounded-2xl px-[38px] pb-[38px] pt-[58px] lg:max-w-[670px] lg:pb-[105px] lg:pl-[105px] lg:pr-[143px] lg:pt-[152px]">
        <h2 className="heading-4 lg:heading-2 dark:text-black-200 mb-9 leading-[115%] tracking-[-0.48px] text-white">
          Work Experience
        </h2>
        <p className="text-white-800 dark:text-white-500 s-regular lg:b-regular mb-10 max-w-[400px] leading-[160%] lg:mb-16">
      ...
      <div className="flex-1">
        <div className="border-white-800 dark:border-black-200 dark:bg-black-200 dark:hover:bg-black-300 flex w-full flex-col gap-8 rounded-[10px] border-[1px] bg-white p-8 transition-all delay-100 duration-300 ease-in hover:translate-x-6 hover:translate-y-9 hover:shadow-[-25px_47px_66px_0px_#00000014] md:flex-row">
          <Image
