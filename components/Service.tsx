		...
		<section className='bg-1'>
			...
			<div className='mt-10 flex flex-wrap justify-center gap-10'>
				{services.map((service) => (
					<div
						key={service.title}
						className='group w-[287px] rounded-[10px] bg-white-800 px-6 py-[30px] shadow-[0px_1px_20px_0px_#E0ECFF] transition-all delay-200 duration-300 ease-linear hover:translate-y-10 hover:bg-accent-primaryLight hover:shadow-[32px_32px_71px_0px_#0252cd47] dark:bg-black-300 dark:shadow-[0px_1px_20px_0px_#1F2E48] dark:hover:bg-accent-primaryDark'
					>
						<div
						...
						<h2 className='base-bold mb-[10px] leading-[130%] text-black-200 group-hover:text-white dark:text-white'>
							{service.title}
						</h2>
