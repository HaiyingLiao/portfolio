...
const CallToAction = () => {
	return (
		<section className='bg-2 flex h-full items-center '>
			<div className="mx-auto flex h-full w-full max-w-[1400px] flex-col items-center justify-center rounded-xl bg-[url('/assets/cta.png')] bg-auto bg-center bg-no-repeat p-4 sm:aspect-video sm:h-[330px] sm:bg-cover sm:p-10 md:flex-row md:justify-between lg:p-12">
